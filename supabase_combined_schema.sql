...
-- ============================================================
-- 000_TRANSITION_EXISTING_DB (Rename old profiles to contacts)
-- ============================================================
ALTER TABLE IF EXISTS public.profiles RENAME TO contacts;
ALTER TABLE IF EXISTS public.contacts RENAME COLUMN whatsapp TO phone;
ALTER TABLE IF EXISTS public.contacts ADD COLUMN IF NOT EXISTS company TEXT;
ALTER TABLE IF EXISTS public.contacts ADD COLUMN IF NOT EXISTS avatar_url TEXT;
