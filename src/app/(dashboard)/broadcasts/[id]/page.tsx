...
export default function BroadcastDetailPage() {
  ...
  const funnelSteps: FunnelStep[] = [
    { label: 'Enviados', value: broadcast.sent_count, color: 'bg-primary' },
    { label: 'Entregues', value: broadcast.delivered_count, color: 'bg-teal-500' },
    { label: 'Lidos', value: broadcast.read_count, color: 'bg-blue-500' },
    { label: 'Respondidos', value: broadcast.replied_count, color: 'bg-indigo-500' },
  ];
          ...
          <Button
            ...
            title={
              broadcast.status === 'sending'
                ? 'Não é possível excluir enquanto uma transmissão está enviando'
