...
export function AppearancePanel() {
  ...
  return (
    <section className="max-w-3xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Aparência"
        description="Defina o modo e a cor de destaque do aplicativo. Salvo neste dispositivo — mude e veja em tempo real."
      />
...
function ModeCard({
  ...
  return (
    <button
      ...
      aria-label={`Usar modo ${mode === "light" ? "claro" : "escuro"}`}
      className={cn(
