      ...
      {sessionExpired && (
        <div className="mb-2 flex items-center justify-between rounded-lg bg-amber-500/10 px-3 py-2">
          <p className="text-xs text-amber-400">
            Sessão de 24 horas expirada. Use um modelo para reatar o contato.
          </p>
          <Button
            variant="ghost"
            size="sm"
        ...
        <div className="flex items-end gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              ...
              title={
                readOnly
                  ? "Apenas leitura — sua função não pode enviar mensagens"
                  : inputsDisabled
                    ? undefined
                    : "Anexar mídia"
              }
          ...
          <textarea
            ...
            placeholder={
              readOnly
                ? "Apenas leitura — visualizadores podem navegar mas não responder"
                : sessionExpired
            ...
            title={readOnly ? "Apenas leitura — sua função não pode enviar mensagens" : undefined}
            className={cn(
