...
const PORTUGUESE_DAYS = ['Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb', 'Dom']
      ...
      <div className="p-5">
        {loading || !data ? (
          ...
          <EmptyState
            ...
            hint="Este gráfico será preenchido conforme você responde às mensagens dos clientes."
          />
        ) : (
          <BarChart
            data={chartData}
            ...
            // the brand accent the brand accent the brand accent.
            colors={['violet']}
