    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Quantidade de negócios neste funil que não estão marcados como Perdidos. Negócios ganhos ainda são incluídos."
        />
        <Metric
        ...
        <Metric
          ...
          tooltip="Valor do Funil dividido pelo Total de Negócios — o valor médio de um único negócio não perdido."
        />
        <Metric
          icon={<TrendingUp className="h-4 w-4 text-purple-400" />}
          label="Valor Ponderado"
          value={formatCurrency(stats.weightedValue, defaultCurrency)}
          tooltip="Receita esperada: o valor de cada negócio aberto × a probabilidade de sua etapa. A primeira etapa ≈ 10%, as etapas progridem até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
