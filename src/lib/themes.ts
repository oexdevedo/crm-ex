...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "violet",
    name: "Violeta",
    tagline: "O padrão — confiante e moderno.",
  ...
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul B2B-SaaS limpo — calmo e corporativo.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Âmbar",
    tagline: "Quente e amigável — ótimo para equipes locais e PMEs.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Ousado e moderno — ideal para marcas de lifestyle e D2C.",
